            ...
            <v-col :cols="cols[0]">
                <v-sheet class="">
                    <v-avatar color="white" size="200" rounded="10" variant='elevated'>
                        <v-img cover :src="memberInfo.thumbnail"></v-img>
                    </v-avatar>
            ...
            <v-col :cols="cols[1]">
                <v-sheet class="">
                    ...
                    <v-row style="height: 150px;">
                        <v-col cols="4" class="text-subtitle-2" align-self="end">
                            帳號創建時間: {{ formatDate(memberInfo.createdAt) }}
                        </v-col>
                        <v-col cols="4" class="ms-10 text-subtitle-2" align-self="end">
