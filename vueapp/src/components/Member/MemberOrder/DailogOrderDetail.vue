    ...
    <v-dialog v-model="dialog" width="1000" @close="commentBTN = false">
        <v-card>
            ...
            <div class="d-flex flex-row mx-auto mt-2">
                ...
                <div style="width:150px;" class="ms-4">
                    <p>收件人電話</p>
                </div>
            ...
            <div class="d-flex justify-end me-3 mb-2">
                ...
                <v-card-actions style="width: 100px !important;" class="me-15"
                    ...
                    <v-btn variant="tonal" color="orange-darken-3" @click="commentBTN = true">前往評價</v-btn>
                </v-card-actions>
                <v-card-actions style="width: 100px !important;" class="me-8">
                    <v-btn variant="tonal" color="orange-darken-3" block @click="dialog = false">關閉</v-btn>
                </v-card-actions>
            </div>
            <div v-if="commentBTN">
