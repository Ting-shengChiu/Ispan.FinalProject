        ...
        items.value = items.value.map((item, index) => {
            ...
            if (filteredDiscounts.length !== 0) {
                filteredDiscounts.map((filDiscount, i) => {
                    ...
                    if (discountIndex !== -1 && filDiscount.discountPerPrices.length !== 0) {
                        discount += filDiscount.discountPerPrices[i];
            ...
            if (freebieDiscounts.length !== 0) {
                freebieDiscounts.map((freeDiscount, i) => {
                    ...
                    if (discountIndex !== -1) {
                        ...
                        freebieImg = freebieName !== '' ? new URL(freebieDiscounts[i].activityDiscount.freebieImg, import.meta.url).href : '';
                    }
                }
                );
            }
