        ...
        <v-container class="mw-xl">
            <v-row no-gutters>
                <v-col cols="12" class="d-flex justify-center">
                    <v-img width="75%" aspect-ratio="16/9" cover :src="title" 
                        transition="slide-x-transition"></v-img>
                </v-col>
            </v-row>
            <v-row no-gutters>
                <v-col cols="4"><v-img width="100%" aspect-ratio="16/9" cover
                        :src=skillpage1></v-img></v-col>
                <v-col cols="4"><v-img height="100%" aspect-ratio="16/9" cover
                        :src=skillpage2></v-img></v-col>
                <v-col cols="4"><v-img width="100%" aspect-ratio="16/9" cover
                        :src=skillpage3></v-img></v-col>
            </v-row>
