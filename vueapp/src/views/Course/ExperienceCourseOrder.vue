...
const Todata = computed(() => {
    ...
    // const dateTimeString = `${form.value.date} ${form.value.startTime}`;
...
//console.log(typeof (Todata.value))
            ...
            <v-container class="d-flex justify-center align-center">
                <el-form :model="form" label-width="120px" class="custom-form ">
                    ...
                    <v-row>
                        <v-col>
                            <el-form-item label="人數:">
                                <!-- <el-input v-model.number="form.peopleNumber" @input="handleInput"/> -->
                    ...
                    <v-row>
                        ...
                        <v-col>
                            <el-form-item>
                                <!-- <RouterLink to="/ExperienceCourseFinish"> -->
